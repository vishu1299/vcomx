...
const Upcomming= () => {
  const [timeLeft, setTimeLeft] = useState({ days: 2, hours: 58, minutes: 36, seconds: 44 });
  ...
  <div>
    ...
    <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col md:flex-row items-center p-6">
      <div className="text-white flex flex-col gap-3 w-full md:w-auto">
        <h2 className="text-[24px] md:text-[40px] leading-6 text-[#FFFFFF] font-Oswald font-bold">
       {` Legends' Arena `}
        </h2>
        ...
        <div className=" bg-[#FF6F3C] w-full md:w-[200px] flex  lg:mt-[30px] justify-center items-center gap-4 text-white p-3 rounded-lg text-sm font-medium">
