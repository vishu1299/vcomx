...
function App() {
  ...
  return (
    <div className=" bg-white flex m-12 relative ">
      ...
      <div className="relative p-12 flex flex-col justify-center m-12 bg-[#f0f0f0] rounded-3xl">
        <h2 className="text-[28px] font-semibold text-gray-900 mx-8">
          Real-Time Analytics and Insights
        </h2>
        <div className="mt-8">
          <img
            src="/src/Assets/Images/vendor_signin.svg"
        ...
        <p className="text-gray-500 text-[18px]  mx-8">
