...
<div className=" px-4 ">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mt-6 py-4">
            ...
            <div>
              <p className="font-semibold text-[#FFFFFF] text-[18px] font-Oswald">Quick Links</p>
            ...
            <div>
              <p className="font-semibold text-[#FFFFFF] text-[18px] font-Oswald">Categories</p>
              <ul className="space-y-1 text-[#B8BEC2] text-[15px] font-Oswald font-normal">
                <li>Vegetable</li>
                <li>Fresh Fruits</li>
                <li>Fresh Meats</li>
            ...
            <div>
              <p className="font-semibold text-[#FFFFFF] text-[18px] font-Oswald">Help Center</p>
              <ul className="space-y-1 text-[#B8BEC2] text-[15px] font-Oswald font-normal">
                <li>Help & FAQs</li>
            ...
            <div>
              <p className="font-semibold text-[#FFFFFF] text-[18px] font-Oswald">Contact info</p>
              <ul className="space-y-1 text-[#B8BEC2] text-[15px] font-Oswald font-normal">
