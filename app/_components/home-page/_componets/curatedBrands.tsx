...
const brands: BrandItem[] = [
  ...
  { bg: "/assets/Images/CURATEDBRANDS/Background (1).png", fg: "/assets/Images/CURATEDBRANDS/Frame 32.png", name: "LOREM", size: "200 ML" },
  { bg: "/assets/Images/CURATEDBRANDS/Background (2).png", fg: "/assets/Images/CURATEDBRANDS/Frame 32.png", name: "LOREM", size: "200 ML" },
  
  { bg: "/assets/Images/CURATEDBRANDS/Background (3).png", fg: "/assets/Images/CURATEDBRANDS/Frame 32.png", name: "LOREM", size: "200 ML" },
  { bg: "/assets/Images/CURATEDBRANDS/Background (1).png", fg: "/assets/Images/CURATEDBRANDS/Frame 32.png", name: "LOREM", size: "200 ML" },
...
const CuratedBrands: React.FC = () => {
  ...
  return (
    <div className="py-10flex flex-col items-center justify-center">
    ...
    <div className="bg-[#FCEEE7] w-full">
            ...
            >
              {brands.map((brand, index) => (
                ...
                <div
                  ...
                  className="relative flex-shrink-0 flex flex-col items-center justify-end h-80 w-full rounded-lg overflow-hidden"
                >
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute top-[30%] inset-0 flex flex-col items-center justify-center">
                      ...
                      <div className="mt-auto mb-4 bg-white px-3 py-1 text-sm rounded flex gap-2">
                        <p className="font-bold text-sm text-[#111111]">{brand.name}</p>
      ...
      <div className="flex flex-col md:flex-row gap-4 w-full max-w-6xl p-8 mt-6">
        <div className="relative bg-orange-200 p-5 rounded-lg overflow-hidden flex items-end h-[400px] w-full md:w-1/2">
          <Image
            src="/assets/Images/CURATEDBRANDS/brewier.jpeg"
            alt="Product Image"
            layout="fill"
            objectFit="cover"
          ...
          <div className="left-5 bottom-20 relative z-10">
            ...
            <h2 className="text-xl font-semibold mt-2 text-[#000000]">
              TOURS SAFE<br /> TRUE DISCOUNT
            </h2>
            <button className="mt-3 bg-[#FF6F3C] text-white px-4 py-2 rounded hover:bg-orange-600 transition-colors">Order Now</button>
          </div>
        </div>
        ...
        <div className="relative bg-gray-300 p-5 rounded-lg overflow-hidden flex items-end h-[400px] w-full md:w-1/2">
          ...
          />
          <div className="left-5 bottom-20 relative z-10">
            <h3 className="text-sm font-extralight text-[#555555]">New Product</h3>
            <h2 className="text-xl font-semibold mt-1 text-[#000000]">
              EXPERIENCE TECHNOLOGY<br /> RELAX HIGHLY
            </h2>
            <button className="mt-3 bg-[#FF6F3C] text-white px-4 py-2 rounded hover:bg-orange-600 transition-colors">Order Now</button>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-8 bg-white p-5 rounded-lg shadow w-full max-w-6xl">
        {services.map((service, index) => (
          <div key={index} className="text-center flex flex-col items-center">
            ...
            <p className="text-lg font-semibold text-[#121212]">{service.title}</p>
